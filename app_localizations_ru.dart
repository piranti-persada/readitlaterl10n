...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get accountInformation => 'Ð˜Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ñ Ð¾Ð± Ð°ÐºÐºÐ°ÑƒÐ½Ñ‚Ðµ';

  @override
  String get profilePicture => 'Ð¤Ð¾Ñ‚Ð¾ Ð¿Ñ€Ð¾Ñ„Ð¸Ð»Ñ';

  @override
  String get tapToChange => 'ÐÐ°Ð¶Ð¼Ð¸Ñ‚Ðµ, Ñ‡Ñ‚Ð¾Ð±Ñ‹ Ð¸Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ';

  @override
  String get changeProfilePicture => 'Ð˜Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ Ñ„Ð¾Ñ‚Ð¾ Ð¿Ñ€Ð¾Ñ„Ð¸Ð»Ñ';

  @override
  String get choosePhoto => 'Ð’Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ Ñ„Ð¾Ñ‚Ð¾';

  @override
  String get changePhoto => 'Ð˜Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ Ñ„Ð¾Ñ‚Ð¾';

  @override
  String get profilePictureChooseHint => 'ÐÐ°Ð¶Ð¼Ð¸Ñ‚Ðµ Ð½Ð° Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ðµ, Ñ‡Ñ‚Ð¾Ð±Ñ‹ Ð²Ñ‹Ð±Ñ€Ð°Ñ‚ÑŒ, Ð¾Ð±Ñ€ÐµÐ·Ð°Ñ‚ÑŒ Ð¸ Ð·Ð°Ð³Ñ€ÑƒÐ·Ð¸Ñ‚ÑŒ Ð½Ð¾Ð²Ð¾Ðµ Ñ„Ð¾Ñ‚Ð¾ Ð¿Ñ€Ð¾Ñ„Ð¸Ð»Ñ.';

  @override
  String get changeUsername => 'Ð˜Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ Ð¸Ð¼Ñ Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»Ñ';

  @override
  String get changeEmail => 'Ð˜Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ email';

  @override
  String passwordLastChanged(String date) {
    return 'ÐŸÐ¾ÑÐ»ÐµÐ´Ð½ÐµÐµ Ð¸Ð·Ð¼ÐµÐ½ÐµÐ½Ð¸Ðµ: $date';
  }

  @override
  String get never => 'ÐÐ¸ÐºÐ¾Ð³Ð´Ð°';
  ...
  @override
  String get loadingMessage1 => 'Мы все подготавливаем...';

  @override
  String get loadingMessage2 => 'Подождите немного, мы уже работаем над этим.';

  @override
  String get loadingMessage3 => 'Еще немного, пока мы все подготовим...';

  @override
  String get loadingMessage4 => 'Готовим все для вас...';

  @override
  String get loadingMessage5 => 'Скоро будем готовы.';

  @override
  String get loadingMessage6 => 'Хорошее уже в пути...';

  @override
  String get loadingMessage7 => 'Почти готово для вас...';

  @override
  String get loadingMessage8 => 'Еще чуть чуть, почти закончили.';

  @override
  String get loadingMessage9 => 'Готовим что то классное...';

  @override
  String get loadingMessage10 => 'Разогреваемся.';
}
