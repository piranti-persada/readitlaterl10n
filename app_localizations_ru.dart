...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get otpVerificationTitle => 'Подтверждение OTP';

  @override
  String otpSentTo(String email) {
    return 'Мы отправили 6-значный код на вашу почту $email';
  }

  @override
  String get otpInvalidOrExpired => 'Неверный или просроченный код';

  @override
  String get otpCodeResent => 'Код отправлен повторно';

  @override
  String get otpResendFailed => 'Не удалось повторно отправить код. Попробуйте ещё раз.';
  ...
  @override
  String get otpResendAvailable => 'Вы можете повторно отправить код сейчас';
